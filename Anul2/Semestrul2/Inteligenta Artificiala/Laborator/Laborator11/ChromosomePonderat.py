...
class ChromosomePonderat:
    ...
    def generateChromosome(self):
        ...
        weights = self.__problParam['listOfWeights']
        chromosome = []
        ...
        for node in range(len(neighbours)):
            ...
            if neighbours[node] == 0:
                ...
                neighbour = random.choices(neighbours[node], weights=weights[node], k=1)[0]
    ...
    def crossover(self, c):
        ...
        newChromosome = ChromosomePonderat(self.__problParam)
    ...
    def mutation(self):
        ...
        newNeighbour = random.choices(self.__problParam['listOfNeighbours'][pos],weights=self.__problParam['listOfWeights'][pos],k=1)[0]
