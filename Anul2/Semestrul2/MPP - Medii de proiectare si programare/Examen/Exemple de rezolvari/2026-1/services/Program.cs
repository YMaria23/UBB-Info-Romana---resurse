...
public class Program
{
    public static void  Main(String[] args)
    {
        ...
        string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MutariDB"]?.ConnectionString;
        ...
        props.Add("connectionString", GetConnectionStringByName("MutariDB"));

        if (string.IsNullOrEmpty(connectionString))
        {
            Console.WriteLine("Warning: Connection string 'MutariDB' not found in app.config!");
        }
