...
public class SwimmingFlyingDuck extends Rata implements Inotator {
    public SwimmingFlyingDuck(String username, String password, String email, List<User> prieteni, List<Event> evenimente, TipRata tip, Double viteza, Double rezistenta, Long card) {
